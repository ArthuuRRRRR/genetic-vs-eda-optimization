...
def run_ga_simple(seed,nb_generations,population_size,mutation_rate_pm,trigram_model,dictionary_set,choice_indiv=2,crossover_type="one_point",elitisme=2, etalon=False, losers=0, reseed=2):
    ...
    ga_model = ga(population_size=population_size,mutation_rate_pm=mutation_rate_pm,trigram_model=trigram_model,dictionary_set=dictionary_set,choice_indiv=choice_indiv,crossover_type=crossover_type,elitisme=elitisme, etalon=etalon, losers=losers, reseed=reseed)
...
def run_eda_simple(seed,nb_generations,nombre_prts,population_size,perturbation_aleatoire, trigram_model,dictionary_set,choice_indiv):
    ...
    eda_model = eda(population_size=population_size,perturbation_aleatoire=perturbation_aleatoire,trigram_model=trigram_model,dictionary_set=dictionary_set,choice_indiv=choice_indiv)
...
def monte_carlo_eda(n_runs,nb_generations,nombre_prts,population_size,perturbation_aleatoire,trigram_model,dictionary_set, choice_indiv):
    all_results = []
