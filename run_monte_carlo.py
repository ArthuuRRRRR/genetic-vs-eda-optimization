...
def run_ga_simple(seed,nb_generations,population_size,mutation_rate_pm,trigram_model,dictionary_set,choice_indiv=2,crossover_type="one_point"):
    random.seed(seed)
    np.random.seed(seed)

    ga_model = ga(population_size=population_size,mutation_rate_pm=mutation_rate_pm,trigram_model=trigram_model,dictionary_set=dictionary_set,choice_indiv=choice_indiv,crossover_type=crossover_type)
...
def monte_carlo_ga(n_runs,nb_generations,population_size,mutation_rate_pm,trigram_model,dictionary_set,choice_indiv=2,crossover_type="one_point"):
    all_results = []

    for seed in range(n_runs):
        result = run_ga_simple(seed=seed,nb_generations=nb_generations,population_size=population_size,mutation_rate_pm=mutation_rate_pm,trigram_model=trigram_model,dictionary_set=dictionary_set,choice_indiv=choice_indiv,crossover_type=crossover_type)
